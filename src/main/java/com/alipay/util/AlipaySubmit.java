...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        return buildRequestMysign(prestr);

    }

    public static String buildRequestMysign(String linkString) {
        String mysign = "";
        if(AlipayConfig.sign_type.equals("MD5") ) {
            mysign = MD5.sign(linkString, AlipayConfig.key, AlipayConfig.input_charset);
        }
        return mysign;
    }
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        List<Node> nodeList = doc.selectNodes("//com.alipay/*");
