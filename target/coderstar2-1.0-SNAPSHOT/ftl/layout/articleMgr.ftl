<html>
<head>
    <title><@block name="title"></@block>-文章管理</title>
...
<div id="westPanel" data-options="region:'west',split:false" title="导航菜单" style="width:150px;" about="systemMgr">
    <div class="easyui-accordion" style="width:148px;height:100%;">
        <div title="文章列表" data-options="iconCls:'icon-ok'" style="overflow:auto;padding:10px;">
            <ul class="easyui-tree">
                <li><a href="/articleMgr/index">文章列表</a></li>
            </ul>
        </div>
    </div>
